...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-12 md:gap-20 pb-20 bg-background text-white">
      {/* Hero Section */}
      <section className="relative min-h-[85vh] md:h-[95vh] flex items-center justify-center overflow-hidden py-12 md:py-0">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center space-y-8 md:space-y-10 animate-fade-in">
          <div className="flex justify-center">
            {/* Logo circular optimizado para mobile */}
            <div className="relative w-48 h-48 md:w-80 md:h-80 rounded-full border-4 border-primary p-2 shadow-[0_0_40px_rgba(233,30,99,0.5)] bg-black overflow-hidden group transition-all">
              <Image 
                src={logoImage} 
          ...
          <div className="space-y-4">
            <p className="text-accent font-bold tracking-[0.2em] md:tracking-[0.4em] uppercase text-xs md:text-sm animate-pulse neon-text-cyan">
              LOS ORIGINALES
            </p>
            <h1 className="text-5xl md:text-9xl font-headline font-bold mb-4 leading-tight tracking-tighter">
              COCTELS <span className="text-primary italic neon-text-magenta">OPS</span>
            </h1>
            <p className="text-lg md:text-2xl mb-8 text-white/70 max-w-2xl mx-auto font-light tracking-wide px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 pt-4 px-6">
            <Button size="lg" className="rounded-full text-base md:text-lg px-8 md:px-12 py-6 md:py-8 bg-primary text-white hover:bg-primary/90 neon-shadow-magenta transition-all" asChild>
              <Link href="/menu">
                VER EL MENÚ <ArrowRight className="ml-2 w-5 h-5" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="rounded-full text-base md:text-lg px-8 md:px-12 py-6 md:py-8 border-accent text-accent hover:bg-accent/10 transition-all" asChild>
      ...
      <section className="container mx-auto px-4">
        <div className="bg-card/50 border border-primary/30 rounded-[2rem] md:rounded-[3.5rem] p-6 md:p-16 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="space-y-8 md:space-y-10">
              ...
              <div className="space-y-4 md:space-y-6">
                <Link 
                  ...
                  target="_blank"
                  className="flex items-center gap-4 md:gap-6 p-5 md:p-8 rounded-2xl md:rounded-3xl bg-black/60 border border-primary/20 group hover:border-primary/60 transition-all"
                >
                  ...
                  <div>
                    <p className="text-[10px] md:text-xs uppercase tracking-[0.2em] md:tracking-[0.3em] text-accent mb-1 font-bold">Pide por WhatsApp</p>
                    <p className="text-xl md:text-3xl font-bold text-white tracking-widest">324 554 5530</p>
                  </div>
                </Link>

                <div className="flex items-center gap-4 md:gap-6 p-5 md:p-8 rounded-2xl md:rounded-3xl bg-black/60 border border-accent/20">
                  ...
                  <div className="space-y-1 md:space-y-2">
                    <p className="text-[10px] md:text-xs uppercase tracking-[0.2em] md:tracking-[0.3em] text-muted-foreground mb-1 font-bold">También en</p>
              ...
              <div className="flex items-start gap-3 p-4 md:p-6 border-l-4 border-accent bg-accent/5 rounded-r-2xl md:rounded-r-3xl">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] md:text-sm text-muted-foreground italic">"Llegamos frío y potente a todo el barrio."</p>
                </div>
              </div>
            </div>

            <div className="relative aspect-video md:aspect-square rounded-2xl md:rounded-[3rem] overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.8)] border border-white/5 order-first md:order-last">
              <Image 
                src={deliveryImage} 
                alt="Delivery OPS" 
                fill 
              ...
              <div className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8">
                <div className="bg-black/90 backdrop-blur-xl p-3 md:p-5 rounded-xl md:rounded-2xl border border-primary/40 flex items-center justify-between">
                  <span className="font-bold text-[10px] md:text-sm uppercase tracking-widest text-white">SERVICIO ACTIVO</span>
                  <span className="flex items-center gap-2 md:gap-3 text-green-400 text-[10px] md:text-sm font-black">
      ...
      <section className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-16 gap-4">
          <div className="space-y-1 md:space-y-2">
            ...
            <p className="text-muted-foreground tracking-[0.2em] uppercase text-[10px]">Mezclas exclusivas de la casa</p>
          </div>
          <Button variant="outline" className="border-primary text-primary rounded-full hover:bg-primary/10 px-6 md:px-8 text-sm md:text-base" asChild>
      ...
      <section className="container mx-auto px-4">
        <div className="relative rounded-[2rem] md:rounded-[3.5rem] overflow-hidden bg-gradient-to-br from-primary via-primary/80 to-purple-900 p-8 md:p-24 text-white">
          <div className="md:w-1/2 space-y-6 md:space-y-8 relative z-10">
            <div className="inline-flex items-center gap-2 bg-white/20 px-4 md:px-6 py-1.5 md:py-2 rounded-full text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] backdrop-blur-xl border border-white/30">
            ...
            <Button size="lg" variant="secondary" className="w-full md:w-auto rounded-full bg-white text-primary hover:bg-white/90 px-8 md:px-10 py-6 md:py-8 font-bold text-base md:text-lg shadow-2xl" asChild>
